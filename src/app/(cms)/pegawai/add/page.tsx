...
export default function AddPegawaiPage() {
  ...
  const [selectedTempatLahir, setSelectedTempatLahir] = useState<Wilayah | null>(null);
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      const response = await Request.POST('/pegawai', payload);
      if (response.success) {
        toast.success(response.message || 'Pegawai berhasil ditambahkan');
        router.push('/pegawai');
      } else {
        if (response.errors && typeof response.errors === 'object') {
          ...
          toast.error(response.message || 'Gagal menambahkan pegawai');
        }
      }
    } catch {
          ...
          <div className='row g-3'>
            ...
            <div className='col-12 col-md-6'>
              <AutocompleteInput
                ...
                error={
                  !selectedTempatLahir && tempatLahirKeyword
                    ? undefined
                    : undefined
                }
                onChange={(v) => {
                  ...
                  <div className='col-12 col-md-2'>
                    ...
                    <input
                      ...
                      {...register(`pendidikan.${index}.tahunLulus`, {
                        pattern: { value: /^\d{4}$/, message: '4 digit tahun' },
                      })}
                    />
                  </div>
